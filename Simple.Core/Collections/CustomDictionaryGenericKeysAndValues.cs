...
{
    /// <summary>
    /// Represents a collection of keys and values. Original dictionary is <see cref="T:System.Collections.IDictionary`2"></see> interface and it is wrapped to UKey and UValue type for TKey and TValue, respectively.
    /// Note that any element of the input list must be custable to the UKey and UValue type from TKey and TValue, respectively.
    /// </summary>
    /// <typeparam name="TKey">The type of the keys in the dictionary.</typeparam>
    /// <typeparam name="UValue">The type of the values in the dictionary.</typeparam>
    [Serializable]
    public class CustomDictionary<TKey, TValue, UKey, UValue> : IDictionary<UKey, UValue>, ICollection<KeyValuePair<UKey, UValue>>, IEnumerable<KeyValuePair<UKey, UValue>>, IDictionary, ICollection, IEnumerable, ISerializable, IDeserializationCallback
        where UKey : TKey
        where UValue : TValue
    {
        ...
        private CustomCollection<TKey, UKey> customKeys;
        private CustomCollection<TValue, UValue> customValues;
        private ReadOnlyDictionary<UKey, UValue> readOnlyDictionary = null;
        ...
        public ReadOnlyDictionary<UKey, UValue> AsReadOnly()
        {
            if (this.readOnlyDictionary == null)
            {
                this.readOnlyDictionary = new ReadOnlyDictionary<UKey, UValue>(this);
            }
        ...
        /// <returns>
        /// true if the <see cref="CustomDictionary&lt;TKey, TValue, UKey, UValue&gt;"/> contains an element with the key; otherwise, false.
        /// </returns>
        /// <exception cref="T:System.ArgumentNullException">key is null.</exception>
        public bool ContainsKey(UKey key)
        {
            return this.CustomKeys.Contains(key);
        }

        /// <summary>
        /// Determines whether the <see cref="CustomDictionary&lt;TKey, TValue, UKey, UValue&gt;"/> contains an element with the specified value.
        /// </summary>
        /// <param name="value">The value to locate in the <see cref="CustomDictionary&lt;TKey, TValue, UKey, UValue&gt;"/>. The value can be null for reference types.
        /// <returns>
        /// true if the <see cref="CustomDictionary&lt;TKey, TValue, UKey, UValue&gt;"/> contains an element with the value; otherwise, false.
        /// </returns>
        ...
        public IEnumerator<KeyValuePair<UKey, UValue>> GetEnumerator()
        {
            foreach (KeyValuePair<TKey, TValue> keyValuePair in this.OriginalDictionary)
                yield return new KeyValuePair<UKey, UValue>((UKey)keyValuePair.Key, (UValue)keyValuePair.Value);
        }
        ...
        /// <value></value>
        /// <returns>An <see cref="T:System.Collections.Generic.ICollection`1"></see> containing the keys of the object that implements <see cref="T:System.Collections.Generic.IDictionary`2"></see>.</returns>
        protected CustomCollection<TKey, UKey> CustomKeys
        {
            get
            {
                if (this.customKeys == null)
                {
                    this.customKeys = new CustomCollection<TKey, UKey>(this.originalDictionary.Keys);
                }
        ...
        /// </returns>
        bool ICollection<KeyValuePair<UKey, UValue>>.Contains(KeyValuePair<UKey, UValue> item)
        {

            foreach (KeyValuePair<UKey, UValue> keyValuePair in this)
            {
        ...
        void ICollection<KeyValuePair<UKey, UValue>>.Add(KeyValuePair<UKey, UValue> item)
        {
        ...
        /// </returns>
        bool ICollection<KeyValuePair<UKey, UValue>>.Remove(KeyValuePair<UKey, UValue> item)
        {
        ...
        void ICollection<KeyValuePair<UKey, UValue>>.CopyTo(KeyValuePair<UKey, UValue>[] array, int arrayIndex)
        {
            int j = arrayIndex;
        ...
        {
            get { return this[(UKey)key]; }
            set { this[(UKey)key] = (UValue)value; }
        }
        ...
        {
            return this.ContainsKey((UKey)key);
        }
        ...
        {
            this.Add((UKey)key, (UValue)value);
        }
