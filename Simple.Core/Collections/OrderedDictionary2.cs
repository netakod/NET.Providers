...
namespace Simple.Collections
{
	...
	[Serializable]
	public class OrderedDictionary2<TKey,TValue> : DictionaryBase<TKey,TValue>, ICloneable//, IOrderedDictionary, IDictionary, ICollection, IEnumerable, ISerializable, IDeserializationCallback, ICloneable
	{
		...
		public OrderedDictionary2(IComparer<TKey> comparer) :
		...
		public OrderedDictionary2(Comparison<TKey> comparison) :
            this(null, Comparers.ComparerFromComparison(comparison), Comparers.ComparerKeyValueFromComparisonKey<TKey, TValue>(comparison))
		{
        }

		///// <summary>
		///// Creates a new OrderedDictionary. The passed delegate will be used to compare KeyValuePairs in this dictionary.
		///// </summary>
		///// <param name="comparison">A delegate to a method that will be used to compare KeyValuePairs.</param>
		//public OrderedDictionary(Comparison<KeyValuePair<TKey, TValue>> comparison) :
		//	this(null, null, Comparers.ComparerFromComparison(comparison))
		//{
		//}
		...
		/// <exception cref="InvalidOperationException">TKey does not implement IComparable&lt;TKey&gt;.</exception>
		public OrderedDictionary2(IEnumerable<KeyValuePair<TKey,TValue>> keysAndValues)
        ...
        /// <param name="keysAndValues">A collection of keys and values whose contents are used to initialized the dictionary.</param>
        /// <param name="comparer">An instance of IComparer&lt;TKey&gt; that will be used to compare keys.</param>
        public OrderedDictionary2(IEnumerable<KeyValuePair<TKey, TValue>> keysAndValues, IComparer<TKey> comparer)
        ...
        /// <param name="keysAndValues">A collection of keys and values whose contents are used to initialized the dictionary.</param>
        /// <param name="comparison">A delegate to a method that will be used to compare keys.</param>
        public OrderedDictionary2(IEnumerable<KeyValuePair<TKey, TValue>> keysAndValues, Comparison<TKey> comparison)
        ...
        private OrderedDictionary2(IEnumerable<KeyValuePair<TKey,TValue>> keysAndValues, IComparer<TKey> keyComparer, IComparer<KeyValuePair<TKey,TValue>> pairComparer)
		{
            this.keyComparer = keyComparer;
            this.pairComparer = pairComparer;
            this.tree = new RedBlackTree<KeyValuePair<TKey,TValue>>(this.pairComparer);
        ...
        private OrderedDictionary2(IComparer<TKey> keyComparer, IComparer<KeyValuePair<TKey, TValue>> pairComparer, RedBlackTree<KeyValuePair<TKey, TValue>> tree)
        {
            this.keyComparer = keyComparer;
            this.pairComparer = pairComparer;
            this.tree = tree;
        ...
        public OrderedDictionary2<TKey,TValue> Clone()
		{
			OrderedDictionary2<TKey,TValue> newDict = new OrderedDictionary2<TKey,TValue>(keyComparer, pairComparer, tree.Clone());
			return newDict;
		}
		...
		public OrderedDictionary2<TKey,TValue> CloneContents()
		{
            ...
            OrderedDictionary2<TKey, TValue> newDict = new OrderedDictionary2<TKey, TValue>(null, keyComparer, pairComparer);
        ...
        {
            private readonly OrderedDictionary2<TKey,TValue> myDictionary;
            ...
            internal View(OrderedDictionary2<TKey, TValue> myDictionary, RedBlackTree<KeyValuePair<TKey, TValue>>.RangeTester rangeTester, bool entireTree, bool reversed)
            {
