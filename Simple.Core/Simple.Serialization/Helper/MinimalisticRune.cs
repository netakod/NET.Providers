...
namespace System.Text
{
    ...
    /// assuming that the underlying <see cref="MinimalisticRune"/> instance is well-formed.
    /// </remarks>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly struct MinimalisticRune : IComparable, IComparable<MinimalisticRune>, IEquatable<MinimalisticRune>
...
#pragma warning restore SA1001
#endif
    {
        ...
        /// <summary>
        /// Creates a <see cref="MinimalisticRune"/> from the provided UTF-16 code unit.
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">
        /// If <paramref name="ch"/> represents a UTF-16 surrogate code point
        /// U+D800..U+DFFF, inclusive.
        /// </exception>
        public MinimalisticRune(char ch)
        {
            uint expanded = ch;
        ...
        /// <summary>
        /// Creates a <see cref="MinimalisticRune"/> from the provided UTF-16 surrogate pair.
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">
        ...
        /// </exception>
        public MinimalisticRune(char highSurrogate, char lowSurrogate)
            : this((uint)char.ConvertToUtf32(highSurrogate, lowSurrogate), false)
        {
        }

        /// <summary>
        /// Creates a <see cref="MinimalisticRune"/> from the provided Unicode scalar value.
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">
        /// If <paramref name="value"/> does not represent a value Unicode scalar value.
        /// </exception>
        public MinimalisticRune(int value)
            : this((uint)value)
        {
        }
        ...
        /// </exception>
        //[CLSCompliant(false)]
        public MinimalisticRune(uint value)
        {
        ...
        // non-validating ctor
        private MinimalisticRune(uint scalarValue, bool _)
        {
            UnicodeDebug.AssertIsValidScalar(scalarValue);
            _value = scalarValue;
        }

        public static bool operator ==(MinimalisticRune left, MinimalisticRune right) => left._value == right._value;
        ...
        public static explicit operator MinimalisticRune(char ch) => new MinimalisticRune(ch);

        //[CLSCompliant(false)]
        public static explicit operator MinimalisticRune(uint value) => new MinimalisticRune(value);

        public static explicit operator MinimalisticRune(int value) => new MinimalisticRune(value);
        ...
        /// <summary>
        /// A <see cref="MinimalisticRune"/> instance that represents the Unicode replacement character U+FFFD.
        /// </summary>
        public static MinimalisticRune ReplacementChar => UnsafeCreate(UnicodeUtility.ReplacementChar);
...
//        }
//#else
//        private static MinimalisticRune ChangeCaseCultureAware(MinimalisticRune rune, CultureInfo culture, bool toUpper)
//        {
//            Debug.Assert(!GlobalizationMode.Invariant, "This should've been checked by the caller.");
...
//#endif
        ...
        public int CompareTo(MinimalisticRune other) => this.Value - other.Value; // values don't span entire 32-bit domain; won't integer overflow

        /// <summary>
        /// Decodes the <see cref="MinimalisticRune"/> at the beginning of the provided UTF-16 source buffer.
        /// </summary>
        /// <returns>
        /// <para>
        /// If the source buffer begins with a valid UTF-16 encoded scalar value, returns <see cref="OperationStatus.Done"/>,
        /// and outs via <paramref name="result"/> the decoded <see cref="MinimalisticRune"/> and via <paramref name="charsConsumed"/> the
        /// number of <see langword="char"/>s used in the input buffer to encode the <see cref="MinimalisticRune"/>.
        /// </para>
        /// <para>
        ...
        /// </remarks>
        public static OperationStatus DecodeFromUtf16(ReadOnlySpan<char> source, out MinimalisticRune result, out int charsConsumed)
        {
            if (!source.IsEmpty)
            {
...
InvalidData:
        ...
        /// <summary>
        /// Decodes the <see cref="MinimalisticRune"/> at the beginning of the provided UTF-8 source buffer.
        /// </summary>
        /// <returns>
        /// <para>
        /// If the source buffer begins with a valid UTF-8 encoded scalar value, returns <see cref="OperationStatus.Done"/>,
        /// and outs via <paramref name="result"/> the decoded <see cref="MinimalisticRune"/> and via <paramref name="bytesConsumed"/> the
        /// number of <see langword="byte"/>s used in the input buffer to encode the <see cref="MinimalisticRune"/>.
        /// </para>
        /// <para>
        ...
        /// invalid sequences while iterating through the loop.
        /// </remarks>
        public static OperationStatus DecodeFromUtf8(ReadOnlySpan<byte> source, out MinimalisticRune result, out int bytesConsumed)
        {
...
Invalid:
        ...
        /// <summary>
        /// Decodes the <see cref="MinimalisticRune"/> at the end of the provided UTF-16 source buffer.
        /// </summary>
        /// <remarks>
        /// This method is very similar to <see cref="DecodeFromUtf16(ReadOnlySpan{char}, out MinimalisticRune, out int)"/>, but it allows
        ...
        /// </remarks>
        public static OperationStatus DecodeLastFromUtf16(ReadOnlySpan<char> source, out MinimalisticRune result, out int charsConsumed)
        {
        ...
        /// <summary>
        /// Decodes the <see cref="MinimalisticRune"/> at the end of the provided UTF-8 source buffer.
        /// </summary>
        /// <remarks>
        /// This method is very similar to <see cref="DecodeFromUtf8(ReadOnlySpan{byte}, out MinimalisticRune, out int)"/>, but it allows
        /// the caller to loop backward instead of forward. The typical calling convention is that on each iteration
        /// of the loop, the caller should slice off the final <paramref name="bytesConsumed"/> elements of
        /// the <paramref name="source"/> buffer.
        /// </remarks>
        public static OperationStatus DecodeLastFromUtf8(ReadOnlySpan<byte> source, out MinimalisticRune value, out int bytesConsumed)
        {
            int index = source.Length - 1;
            if ((uint)index < (uint)source.Length)
            {
...
// and see if we consumed the entirety of the buffer.
                ...
                OperationStatus operationStatus = DecodeFromUtf8(source, out MinimalisticRune tempRune, out int tempBytesConsumed);
        ...
        /// <summary>
        /// Encodes this <see cref="MinimalisticRune"/> to a UTF-16 destination buffer.
        /// </summary>
        ...
        /// <summary>
        /// Encodes this <see cref="MinimalisticRune"/> to a UTF-8 destination buffer.
        /// </summary>
        ...
        public override bool Equals([NotNullWhen(true)] object obj) => (obj is MinimalisticRune other) && Equals(other);

        public bool Equals(MinimalisticRune other) => this == other;

        public override int GetHashCode() => Value;

        /// <summary>
        /// Gets the <see cref="MinimalisticRune"/> which begins at index <paramref name="index"/> in
        ...
        /// </remarks>
        public static MinimalisticRune GetRuneAt(string input, int index)
        {
        ...
        /// <summary>
        /// Returns a <see cref="string"/> representation of this <see cref="MinimalisticRune"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to create a <see cref="MinimalisticRune"/> from the provided input value.
        /// </summary>
        public static bool TryCreate(char ch, out MinimalisticRune result)
        {
        ...
        /// <summary>
        /// Attempts to create a <see cref="MinimalisticRune"/> from the provided UTF-16 surrogate pair.
        /// Returns <see langword="false"/> if the input values don't represent a well-formed UTF-16surrogate pair.
        /// </summary>
        public static bool TryCreate(char highSurrogate, char lowSurrogate, out MinimalisticRune result)
        {
        ...
        /// Attempts to create a <see cref="MinimalisticRune"/> from the provided input value.
        /// </summary>
        public static bool TryCreate(int value, out MinimalisticRune result) => TryCreate((uint)value, out result);

        /// <summary>
        /// Attempts to create a <see cref="MinimalisticRune"/> from the provided input value.
        /// </summary>
        public static bool TryCreate(uint value, out MinimalisticRune result)
        {
            if (UnicodeUtility.IsValidUnicodeScalar(value))
            {
        ...
        private static bool TryEncodeToUtf16(MinimalisticRune value, Span<char> destination, out int charsWritten)
        {
        ...
        /// <summary>
        /// Encodes this <see cref="MinimalisticRune"/> to a destination buffer as UTF-8 bytes.
        /// </summary>
        /// <param name="destination">The buffer to which to write this value as UTF-8.</param>
        ...
        private static bool TryEncodeToUtf8(MinimalisticRune value, Span<byte> destination, out int bytesWritten)
        {
        ...
        /// <summary>
        /// Attempts to get the <see cref="MinimalisticRune"/> which begins at index <paramref name="index"/> in
        /// string <paramref name="input"/>.
        /// </summary>
        ...
        /// </remarks>
        public static bool TryGetRuneAt(string input, int index, out MinimalisticRune value)
        {
            int runeValue = ReadRuneFromString(input, index);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static MinimalisticRune UnsafeCreate(uint scalarValue) => new MinimalisticRune(scalarValue, false);
...
//        }
        ...
        {
            return UnicodeUtility.IsInRangeInclusive((uint)category, (uint)UnicodeCategory.UppercaseLetter, (uint)UnicodeCategory.OtherLetter) || (category == UnicodeCategory.DecimalDigitNumber);
        }
        ...
        public static bool IsControl(MinimalisticRune value)
        {
        ...
        public static bool IsWhiteSpace(MinimalisticRune value)
        {
            if (value.IsAscii)
            {
...
//            if (GlobalizationMode2.Invariant)
//            {
...
//        }
        ...
        int IComparable.CompareTo(object obj)
        {
            ...
            if (obj is MinimalisticRune other)
                return this.CompareTo(other);

            throw new ArgumentException("Arg must be Rune"); // SR.Arg_MustBeRune;
        }
    }
}
