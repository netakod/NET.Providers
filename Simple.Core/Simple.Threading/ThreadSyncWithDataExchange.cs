...
{
    public class ThreadSyncWithDataExchange<TKey, TValue> : ThreadSync<TKey>
    {
        object lockObject = new object();
        public Dictionary<object, TValue> returnValues = new Dictionary<object, TValue>();

        public new TValue WaitFor(TKey token) => this.WaitFor(token, Int32.MaxValue);
        ...
        public new TValue WaitFor(TKey token, int timeout)
        {
