...
namespace Simple.Network
{
  ...
  //      {
		...
		/// <summary>
		/// Parse endpoint text address or hostname text with or without port info.
		/// Example: wwww.myserver.com
		///			 https://myserver.com
		///			 myserver.com 8080
		///			 myserver.com:8080
		...
		///			 192.168.1.0 9000
		/// </summary>
		/// <param name="endpointText"></param>
		/// <returns>IP addres or hostname. Port is ignored.</returns>
		public static string GetIpAddressOrHostname(string endpointText)
		{
			string hostname = endpointText;
			//int port = defaultPort;
			string[] list = endpointText.Split(new char[] { ':', ',', ';', ' ' }, StringSplitOptions.RemoveEmptyEntries);
