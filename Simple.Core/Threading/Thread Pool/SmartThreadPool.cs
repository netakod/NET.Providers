...
using Simple.Threading.Internal;
...
namespace Simple.Threading
{
	...
	public partial class SmartThreadPool : WorkItemsGroupBase, IDisposable
	{
		...
		/// </summary>
        private readonly Simple.Threading.Internal.SynchronizedDictionary<Thread, ThreadEntry> _workerThreads = new Internal.SynchronizedDictionary<Thread, ThreadEntry>();
		...
		/// </summary>
        private readonly Simple.Threading.Internal.SynchronizedDictionary<IWorkItemsGroup, IWorkItemsGroup> _workItemsGroups = new Internal.SynchronizedDictionary<IWorkItemsGroup, IWorkItemsGroup>();
        ...
        public override void Start()
        {
            ...
            var workItemsGroups = _workItemsGroups.Values;
