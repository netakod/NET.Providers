...
{
	public class ClientUserSettings : AppSettings
	{
		...
		public const string SettingFormFindWindowLocationX = "FormFindWindowLocationX";
		public const string SettingFormFindWindowLocationY = "FormFindWindowLocationY";
		//public const string SettingFormFindWindowWidth = "FormFindWindowWidth";
		//public const string SettingFormFindWindowHeight = "FormFindWindowHeight";
		public const string SettingFormFindWindowState = "FormFindWindowState";
		...
		public int Port
		{
			get { return this.GetValue<int>(SettingPort, defaultValue: DefaultServerPort); }
			set { this.SetValue(SettingPort, value, defaultValue: DefaultServerPort); }
		}
		...
		public int FormFindWindowLocationX
		{
			get { return this.GetValue<int>(SettingFormFindWindowLocationX); }
			set { this.SetValue(SettingFormFindWindowLocationX, value); }
		}

		public int FormFindWindowLocationY
		{
			get { return this.GetValue<int>(SettingFormFindWindowLocationY); }
			set { this.SetValue(SettingFormFindWindowLocationY, value); }
		}

		//public int FormFindWindowWidth
		//{
		//	get { return this.GetValue<int>(SettingFormFindWindowWidth); }
		//	set { this.SetValue(SettingFormFindWindowWidth, value); }
		//}

		//public int FormFindWindowHeight
		//{
		//	get { return this.GetValue<int>(SettingFormFindWindowHeight); }
		//	set { this.SetValue(SettingFormFindWindowHeight, value); }
		//}

		public int FormFindWindowState
		{
			get { return this.GetValue<int>(SettingFormFindWindowState); }
			set { this.SetValue(SettingFormFindWindowState, value); }
		}
