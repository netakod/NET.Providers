...
//		public void Connect()
//		{
//			this.telnet = new SimpleTelnet();
//			this.telnet.RemoteHost = this.RemoteHost;
//			this.telnet.RemotePort = this.RemotePort;
...
//		private ValueTask Telnet_TextReceived(string text)
//		{
//			if (this.AcceptData)
//			{
