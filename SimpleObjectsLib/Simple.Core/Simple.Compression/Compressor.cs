...
namespace Simple.Compression
{
    ...
    public abstract class Compressor : Algorithm, IDisposable
    {
        ...
        protected Compressor()
        {
            ...
            _compressor = new ZlibStream(_compressorStream, Ionic.Zlib.CompressionMode.Compress);
            _decompressor = new ZlibStream(_decompressorStream, Ionic.Zlib.CompressionMode.Decompress);
        }
