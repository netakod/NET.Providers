...
//        {
//            Boolean match = true;
//            for (UInt32 i = 0; match && i < size; ++i)
//                match = ((Byte*)m1)[i] == ((Byte*)m2)[i];
//            return match;
//        }
//        private static unsafe Boolean MemCompare(void* m1, String str)
//        {
//            Byte[] source = Encoding.ASCII.GetBytes(str);
//            fixed (Byte* m2 = source)
//                return MemCompare(m1, m2, (UInt32)source.Length);
//        }
...
//                MemCopy(dst, src, (UInt32)source.Length);
//        }
...
//        {
//            UInt32 val = 0;
//            fixed (Byte* src = source) if (MemCompare(src + start, "QCLZ"))
