...
namespace Simple.Collections
{
    ...
    public class CollectionWrapperBase<T, U> : ICollection<U> where U : T
    {
        #region CONSTRUCTOR
        /// <summary>
        ...
        public CollectionWrapperBase(ICollection<T> collection)
        {
