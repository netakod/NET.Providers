...
namespace Simple.Collections
{
	...
	/// To addition to the <see cref="System.Collections.Generic.IList{T}"></see> its implements ReadOnly property like readonly IList wrapper, AsReadOnly method, AsCustom method custom type casting.
	/// </summary>
	/// <typeparam name="T">The type of the elements in the collection.</typeparam>
	[Serializable]
    public class SimpleList<T> : SimpleListBase<T>, IList<T>, ICollection<T>, IEnumerable<T>, IList, ICollection, IEnumerable

    {
        ...
        /// </summary>
        /// <param name="collectionToWrap">The <see cref="System.Collections.Generic.ICollection{T}"></see> to wrap.</param>
        /// <exception cref="T:System.ArgumentNullException">collection is null.</exception>
        public SimpleList(ICollection<T> collectionToWrap)
        ...
        /// </summary>
        /// <param name="collectionToWrap">The <see cref="System.Collections.ICollection"></see> to wrap.</param>
        /// <exception cref="System.ArgumentNullException">collectionToWrap is null.</exception>
        public SimpleList(ICollection collectionToWrap)
            : base(collectionToWrap)
        {
        }
