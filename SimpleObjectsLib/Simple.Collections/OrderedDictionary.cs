...
namespace Simple.Collections // https://github.com/mattmc3/dotmore/blob/master/dotmore/Collections/Generic
{
	/// <summary>
	...
	public class OrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue>
	{
		...
		private void Initialize(IEqualityComparer<TKey> comparer = null)
		{
			...
			if (comparer != null)
			{
				_keyedCollection = new KeyedCollection<TKey, KeyValuePair<TKey, TValue>>(x => x.Key, comparer);
			}
			else
			{
				_keyedCollection = new KeyedCollection<TKey, KeyValuePair<TKey, TValue>>(x => x.Key);
			}
		}
