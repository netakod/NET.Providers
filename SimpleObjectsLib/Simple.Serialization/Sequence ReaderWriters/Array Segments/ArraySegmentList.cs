...
namespace Simple.Serialization
{
	...
	/// The receive cache
	/// </summary>
	public sealed class ArraySegmentList : IList<ArraySegment<byte>>
	{
		...
		internal ArraySegmentList Clone(int index, int segmentOffset, int length)
		{
			var target = new ArraySegmentList();
